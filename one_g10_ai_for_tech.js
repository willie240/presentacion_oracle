    ...
    return (
        <div className="group rounded-2xl border border-stone-200 bg-white p-5 shadow-sm transition hover:border-[#C74634]/40 hover:shadow-md">
            <div className="mb-3 flex flex-wrap items-center gap-2">
                <Badge className="rounded-full bg-[#312D2A]">Curso {index + 1}</Badge>
        ...
        <main className="min-h-screen bg-[#F8F6F3] text-[#312D2A]">
            <section className="relative overflow-hidden bg-[#312D2A] px-6 py-8 text-white md:px-10 lg:px-16">
                <div className="absolute inset-0 opacity-40">
                    <div className="absolute -left-24 top-24 h-80 w-80 rounded-full bg-[#C74634] blur-3xl" />
                    <div className="absolute right-0 top-0 h-96 w-96 rounded-full bg-[#7F2A21] blur-3xl" />
                    <div className="absolute bottom-0 left-1/2 h-80 w-80 rounded-full bg-[#E26D5A] blur-3xl" />
                </div>

                <div className="relative mx-auto max-w-7xl">
                    <header className="mb-14 flex flex-wrap items-center justify-between gap-4 border-b border-white/10 pb-6">
                        <div className="flex items-center gap-3">
                            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#C74634] font-black text-white">A</div>
                            <div>
                                <div className="text-sm font-bold uppercase tracking-[0.24em] text-white/60">Alura Latam</div>
                                <div className="text-sm text-white/70">Learning experience for Oracle</div>
                            </div>
                        </div>
                    ...
                    <div className="grid gap-12 lg:grid-cols-[1.12fr_0.88fr] lg:items-center">
                        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                            ...
                            <div className="mt-9 flex flex-wrap gap-3">
                                <Button className="rounded-full bg-white px-7 py-6 text-[#312D2A] hover:bg-white/90">
                                    Explorar formações <Icons.arrowRight className="ml-2 h-4 w-4" />
                                </Button>
                                <Button variant="outline" className="rounded-full border-white/30 bg-transparent px-7 py-6 text-white hover:bg-white/10 hover:text-white">
            ...
            <section className="relative overflow-hidden bg-[#312D2A] px-6 py-16 text-white md:px-10 lg:px-16">
                <div className="absolute inset-0 opacity-30">
                    <div className="absolute left-0 top-0 h-80 w-80 rounded-full bg-[#C74634] blur-3xl" />
                    <div className="absolute bottom-0 right-0 h-80 w-80 rounded-full bg-[#E26D5A] blur-3xl" />
                </div>
                <div className="relative mx-auto max-w-7xl">
